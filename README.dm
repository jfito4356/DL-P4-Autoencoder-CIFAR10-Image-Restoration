...
An **Autoencoder** is a neural network design paradigm trained in an unsupervised features/targets manner to copy its input to its output under specific algorithmic constraints. It consists of two complementary operational parts:
